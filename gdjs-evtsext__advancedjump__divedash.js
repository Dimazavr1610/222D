...
gdjs.evtsExt__AdvancedJump__DiveDash.DiveDash = class DiveDash extends gdjs.RuntimeBehavior {
  ...
  applyBehaviorOverriding(behaviorOverriding) {
    ...
    if (behaviorOverriding.DiveMaxFallingSpeed !== undefined)
      this._behaviorData.DiveMaxFallingSpeed = behaviorOverriding.DiveMaxFallingSpeed;
    if (behaviorOverriding.DiveInitialFallingSpeed !== undefined)
      this._behaviorData.DiveInitialFallingSpeed = behaviorOverriding.DiveInitialFallingSpeed;
    if (behaviorOverriding.DiveGravity !== undefined)
      this._behaviorData.DiveGravity = behaviorOverriding.DiveGravity;
    if (behaviorOverriding.IsDiving !== undefined)
      this._behaviorData.IsDiving = behaviorOverriding.IsDiving;
